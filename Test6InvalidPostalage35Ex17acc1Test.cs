...
[TestFixture]
public class Test6InvalidPostalage35Ex17acc1Test {
  ...
  [Test]
  public void test6InvalidPostalage35Ex17acc1() {
    ...
    driver.FindElement(By.Id("postalCode")).SendKeys("N2J3B8");
    driver.FindElement(By.Id("phone")).Click();
    driver.FindElement(By.Id("phone")).Click();
    driver.FindElement(By.Id("phone")).SendKeys("548-333-7407");
    driver.FindElement(By.Id("email")).Click();
    driver.FindElement(By.Id("email")).SendKeys("pallavirehan98@gmail.com");
